...
const createListItem = (index,option)=>{
    ...
    const textBox = createDomElement("div", {
        class: "textBox"
    }, []);
    const textBoxWrapper = createDomElement("div", {
        class: "textBoxWrapper"
    }, [textBox]);
    const thumbnail = createDomElement("img", {
        class: "thumbnail",
        src: option.previewImage
    }, [])
    const thumbnailBox = createDomElement("div", {
        style: `width:${5 * scaleFactor}vh;height:${5 * scaleFactor}vh;`,
        class: "thumbnailBox"
    }, [thumbnail]);
    const listItem = createDomElement("div", {
